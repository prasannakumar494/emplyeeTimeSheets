package com.employee.timesheets;
...
public class TestTimeSheetsApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(TimeSheetsApplication::main).with(TestTimeSheetsApplication.class).run(args);
    }
